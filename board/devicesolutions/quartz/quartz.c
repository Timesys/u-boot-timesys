...
unsigned long ddr_ctrl_init(void)
{
	...
	__raw_writel(0x06040404, DDR_CR013);	/* trc, trrd, tccd tbst_int_interval */
	__raw_writel(0x1206040F, DDR_CR014);	/* tfaw, tfp, twtr, tras_min */
	...
	__raw_writel(0x00060101, DDR_CR021);	/* trcd_int, tras_lockout ccAP */
	...
	__raw_writel(0x00000000, DDR_CR052);	/* mr17 and mr16 */
	...
	__raw_writel(0x0a010200, DDR_CR073);	/* ** was 0a010300 for Tower board   arebit, col_diff, row_diff
						   bank_diff */
